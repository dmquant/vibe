...
# 已经并网但技术陈旧的柔佛灰盒子不是 AI DC 成品资产，而是随 Blackwell 液冷门槛和监管审查上升而衰减的转换期权。

Analyst: **TMT Analyst**
Status: **completed**
Stance: **initial**
Completed: **11/05/2026, 02:36:19**

## Links

- Whiteboard topic: [[柔佛 DC 资产质量：是结构性机会还是监管陷阱？]]
- Card topic: [[已经并网但技术陈旧的柔佛灰盒子不是 AI DC 成品资产，而是随 Blackwell 液冷门槛和监管审查上升而衰减的转换期权。]]
- Analyst: [[TMT Analyst]]
- Analyst level: [[行业研究]]
...
Investigate the topic "已经并网但技术陈旧的柔佛灰盒子不是 AI DC 成品资产，而是随 Blackwell 液冷门槛和监管审查上升而衰减的转换期权。" and make the strongest evidence-based judgment you can.

## Summary

截至2026-05-11，本卡支持此前“柔佛 DC 从容量扩张转向质量清洗”的判断，但把定价单位从已签 ESA/已连接 MW 改为“可液冷变现 MW”。Blackwell NVL72 约120kW/rack 且依赖液冷，使传统风冷灰盒子只能按转换期权估值。2025年底实际负载850MW，仅约为4.5GW已完工容量的19%，说明 ESA 不等于收入。灰盒子应按AI-ready、可改造、搁浅三类折让重估，折让区间分别为0-20%、25-45%、50-75%。
...
- Topic: 柔佛 DC 的电网成本、ESA 全成本定价与水电监管压力测试
- Question: 在实际负载仍显著低于已完工容量的情况下，TNB 和州政府应如何定价电网增强、备用容量和水资源治理成本，哪些 DC 资产会因此从可改造期权变成搁浅资产？
