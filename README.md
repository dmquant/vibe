...
layer: a business-facing site and investment portal that exposes sanitized AI
...
- A 100-day temporal research atlas with a synchronized daily cursor, 3D
  thesis/lane/stock universe, research activity river, and expandable episode
  library.
...
| `/investor/portfolio/` | Browser-local thesis portfolio and risk-budget tracker |
...
| `/investor/console/` | Advanced full-corpus research console |
...
| `/investor/portfolio/` | 浏览器本地 thesis 组合与风险预算追踪 |
...
| `/investor/console/` | 面向完整报告语料的高级研究控制台 |
| `/graph/` | 研究图谱与地图式探索 |
...
- Three.js for the data-driven 100-day temporal research universe
