...
description: "AI研究院晨间简报：5个分析板块、20个深度研究、29次跨部门传递。"
pubDate: "2026-05-09"
category: "brief"
lang: "zh"
---
...
| Wind/FactSet/Choice consensus estimates | 因子研究员 → 数据科学家 | normal |
| Stock Connect net-flow data decomposition | 因子研究员 → 数据科学家 | normal |
| A股300成长成交额94%分位拥挤度对五一后行业轮动的影响 | 因子研究员 → A股策略师 | normal |
| A股非制造业PMI跌入收缩（49.4）的下行传导路径 | 因子研究员 → 中国宏观分析师 | normal |
| Industrials AI Premium Audit | 工业制造分析师 → 首席策略师 | normal |
| Defense Budget & Fiscal Pressure | 工业制造分析师 → 全球宏观分析师 | normal |
